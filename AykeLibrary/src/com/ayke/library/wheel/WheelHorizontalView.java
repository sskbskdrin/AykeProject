...
package com.ayke.library.wheel;
...
public class WheelHorizontalView extends AbstractWheelView {
	...
	protected void drawItems(Canvas canvas) {
		...
		if (mSelectionDivider != null) {
			...
			mSelectionDivider.setBounds(leftOfLeftDivider, 0,
					rightOfLeftDivider, h);
			...
			mSelectionDivider.setBounds(leftOfRightDivider, 0,
					rightOfRightDivider, h);
			mSelectionDivider.draw(cSeparators);
			cSeparators.restore();
		}
