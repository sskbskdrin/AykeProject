package com.ayke.library.slidingmenu;
...
public class SlidingFragmentActivity extends FragmentActivity implements SlidingActivityBase {
     ...
     * (non-Javadoc)
     *
     * @see android.app.Activity#getContentView(int)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see android.app.Activity#getContentView(android.view.View)
     */
    @Override
    ...
    public void setBehindContentView(View v) {
        setBehindContentView(v, new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams
                .MATCH_PARENT));
    }
